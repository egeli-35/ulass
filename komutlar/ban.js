           ...
           .then(bans => {
               ...
               message.guild.ban(seyfooo, sebeb)
                   .then(async (member) => {
                       ...
                       message.channel.send(`<@!${user.id}> adlı kullanıcı banlandı <a:ban:751038188901892137>`);
                   })
                   .catch(error => {
           ...
           .then(bans => {
               ...
               message.guild.ban(seyfooo, sebeb)
                   .then(async (member) => {
                       ...
                       message.channel.send(`<@!${user.id}> sunucudan yasaklandı <a:ban:751038188901892137>`);
                   })
                   .catch(error => {
