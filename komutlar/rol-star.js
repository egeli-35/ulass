...
if (!message.member.roles.has('740626457226772570') && !message.member.hasPermission('ADMINISTRATOR')) //KOMUTU KULLANICAK ROL İD
  ...
  if(!member.roles.has(`792372269870743552`)) { //KOMUTLA VERİLECEK OLAN PERMİN İDSİ
    member.addRole(`792372269870743552`)
    let kayıt = new Discord.RichEmbed()
    .setColor("BLACK")
   .addField(`BJORN`, `${kişi} **adlı üyeye** <@&792372269870743552> **rolü verildi!**`)
   .setFooter(`Komutu kullanan yetkili : ${message.author.username}`) 
    ...
    member.removeRole(`792372269870743552`)
    let kayıt = new Discord.RichEmbed()
    .setColor("BLACK")
    .addField(`BJORN`, `${kişi} **adlı üyeden** <@&792372269870743552> **rolü alındı!**`)
    .setFooter(`Komutu kullanan yetkili : ${message.author.username}`) 
            .setThumbnail(`https://cdn.discordapp.com/icons/770625627987378196/a_4466da3ef6682183c5302d9f3b4c5570.webp?size=128`)
